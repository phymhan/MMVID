python3 test.py --name test_iper_text_long \
    --image_text_folder data/iper2 --dataset iper \
    --slow --text_seq_len 16 --dim 768 --which_transformer openai_clip_visual \
    ...
    --dalle_path iper_bert_txtdrop_slow_180k.pt --eval_mode long \
    --long_mode long --t_repeat 50 --t_overlap 7
