python3 train.py --name train_vox_text \
    ...
    --which_vae vqgan1024 --image_size 128 --beta_rel 0.5 --beta_vid 0.5 \
    --beta_msm 7 --log_root logs --lr_scheduler_warmup 5000 \
    --msm_strategy_prob 7,1,1,1 --msm_bernoulli_prob 0.2,0.2 \
    --vid_strategy_prob 1,1,1,1 --dropout_vc 0.4 --dist_url tcp://localhost:10001 \
