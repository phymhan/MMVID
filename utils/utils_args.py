...
def get_args_base():
    ...
    parser.add_argument('--deterministic', action='store_true', help='Deterministic in data loader?')
    parser.add_argument('--frame_num', default=8, type=int, help='Number of frames the data loader loads')
    parser.add_argument('--frame_step', default=4, type=int, help='Step size of the data loader')
    ...
    parser.add_argument('--negvc', action='store_true',
        help='toggle this to use negative visual control from data loader. This is used for REL during training. Default is to swap the control sequence along batch.')
    ...
    parser.add_argument('--dim', default=768, type=int, help='Model dimension (of embeddings)')
    ...
    parser.add_argument('--which_transformer',
                        type=str,
                        default='openai_clip_visual', help='which transformer to use')
