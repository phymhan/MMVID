...
For Quantitative Evaluation (FVD and PRD), append the following arguments to the above testing command:
``` python
--eval_mode eval --eval_metric fvd_prd --eval_num 2048 --batch_size 16 --name_suffix _eval=fvd
```
